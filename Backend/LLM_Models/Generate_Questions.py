...
# ------------------------------- Token estimation -------------------------------
# ------------------------------- System prompt -------------------------------
SYSTEM_PROMPT = ("""You are an MCQ question generator for educational use. For each input text chunk, produce a set of multiple-choice questions that together cover the chunk's main ideas, important facts, and key implications.
...
SYSTEM_PROMPT_ALT = ("""You are an MCQ question generator for educational use. For each input text chunk, produce a set of multiple-choice questions that together cover the chunk's main ideas, important facts, and key implications.
